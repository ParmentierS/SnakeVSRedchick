...
public class GameDeuxJoueur extends Thread {
    ...
    public GameDeuxJoueur(JFrame menu)
    {
        parent = menu;
    }
    /**
    ...
    {  
           ...
           new AWTEventListener()
           {
               public void eventDispatched(AWTEvent event){
                    ...
                    if(ke.getID() == KeyEvent.KEY_PRESSED){
                        switch (ke.getKeyCode()) 
                        { 
                            case KeyEvent.VK_Z     : if(!gameBegin){gameBegin = true; MotionDirection2 = LEFT;}    NewMotionDirection2 = UP;   break; 
                            case KeyEvent.VK_Q     : if(!gameBegin){gameBegin = true; MotionDirection2 = LEFT;}    NewMotionDirection2 = LEFT; break; 
                            case KeyEvent.VK_S     : if(!gameBegin){gameBegin = true; MotionDirection2 = LEFT;}    NewMotionDirection2 = DOWN; break; 
                            case KeyEvent.VK_D     : if(!gameBegin){gameBegin = true; MotionDirection2 = LEFT;}    NewMotionDirection2 = RIGHT;break;
                        }
                    }
                }
            }, AWTEvent.KEY_EVENT_MASK);
        ...
        System.out.println("condition  "+XHead2+"   "+YHead2);
    ...
    public void SnakeMotion2() {
        ...
        // vérifie si la nouvelle direction choisi par le joueur n'est pas l'oposer de la direction dans laquel le serpent de dirige.
        System.out.println("motion 2 start");
        boolean OK = true;
        ...
        switch (MotionDirection2) 
                 { 
                     case UP    :    if (map[YHead2-1][XHead2] == FLOOR)         {graph.Setmap(snake.getTailY(),snake.getTailX(),FLOOR);snake.del();graph.Setmap(YHead2,XHead2,CORPS); graph.Setmap(YHead2-1,XHead2,HEAD_UP); YHead2--;snake.add(XHead2,YHead2);
                                     ...
                                     else if (map[YHead2-1][XHead2] == CORPS)    {win = false; run = false; level = false; }
                                     else if (map[YHead2-1][XHead2] == TAIL)     {graph.Setmap(snake.getTailY(),snake.getTailX(),FLOOR);snake.del();graph.Setmap(YHead2,XHead2,CORPS); graph.Setmap(YHead2-1,XHead2,HEAD_UP); YHead2--;snake.add(XHead2,YHead2);
                                                                                XTail = snake.getTailX();YTail = snake.getTailY();graph.Setmap(YTail,XTail,TAIL);}
                                     break; 
                     case DOWN  :    if (map[YHead2+1][XHead2] == FLOOR)         {graph.Setmap(snake.getTailY(),snake.getTailX(),FLOOR);snake.del();graph.Setmap(YHead2,XHead2,CORPS); graph.Setmap(YHead2+1,XHead2,HEAD_DOWN); YHead2++;snake.add(XHead2,YHead2);
                                     ...
                                     else if (map[YHead2+1][XHead2] == TAIL)     {graph.Setmap(snake.getTailY(),snake.getTailX(),FLOOR);snake.del();graph.Setmap(YHead2,XHead2,CORPS); graph.Setmap(YHead2+1,XHead2,HEAD_DOWN); YHead2++;snake.add(XHead2,YHead2);
                                                                                XTail = snake.getTailX();YTail = snake.getTailY();graph.Setmap(YTail,XTail,TAIL);}
                                     break; 
                     case RIGHT :    if (map[YHead2][XHead2+1] == FLOOR)         {graph.Setmap(snake.getTailY(),snake.getTailX(),FLOOR);snake.del();graph.Setmap(YHead2,XHead2,CORPS); graph.Setmap(YHead2,XHead2+1,HEAD_RIGHT); XHead2++;snake.add(XHead2,YHead2);
                                     ...
                                     else if (map[YHead2][XHead2+1] == CORPS)    {win = false; run = false; level = false; }
                                     else if (map[YHead2][XHead2+1] == TAIL)     {graph.Setmap(snake.getTailY(),snake.getTailX(),FLOOR);snake.del();graph.Setmap(YHead2,XHead2,CORPS); graph.Setmap(YHead2,XHead2+1,HEAD_RIGHT); XHead2++;snake.add(XHead2,YHead2);
                                                                                XTail = snake.getTailX();YTail = snake.getTailY();graph.Setmap(YTail,XTail,TAIL);}
                                     break; 
                     case LEFT  :    if (map[YHead2][XHead2-1] == FLOOR)         {graph.Setmap(snake.getTailY(),snake.getTailX(),FLOOR);snake.del();graph.Setmap(YHead2,XHead2,CORPS); graph.Setmap(YHead2,XHead2-1,HEAD_LEFT); XHead2--;snake.add(XHead2,YHead2);
                                     ...
                                     else if (map[YHead2][XHead2-1] == TAIL)     {graph.Setmap(snake.getTailY(),snake.getTailX(),FLOOR);snake.del();graph.Setmap(YHead2,XHead2,CORPS); graph.Setmap(YHead2,XHead2-1,HEAD_LEFT); XHead2--;snake.add(XHead2,YHead2);
                                                                                XTail = snake.getTailX();YTail = snake.getTailY();graph.Setmap(YTail,XTail,TAIL);}
                                     break; 
                 }
                 System.out.println("motion 2 end");
