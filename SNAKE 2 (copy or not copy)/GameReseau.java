...
public class GameReseau extends Thread {
    ...
    public int MotionDirection2 = UP;
    public int NewMotionDirection2 = UP;
    ...
    {  
        ...
        window = new JFrame ("----SNAKE--VS--REDCHICK--Serveur-"); 
        ...
        {   
            ...
            CLIENT = new Client(server.accept(),this);
        ...
        catch (IOException e) 
        {
            ...
            {System.out.println("pas reussi a fermer le serveur : " + er);}
        }
           ...
           new AWTEventListener()
           {
               public void eventDispatched(AWTEvent event){
                    ...
                    if(ke.getID() == KeyEvent.KEY_PRESSED){
                        switch (ke.getKeyCode()) 
                        { 
                            case KeyEvent.VK_Z     : if(!gameBegin){gameBegin = true; MotionDirection2 = map[YHead2][XHead2];}    NewMotionDirection2 = UP;   break; 
                            case KeyEvent.VK_Q     : if(!gameBegin){gameBegin = true; MotionDirection2 = map[YHead2][XHead2];}    NewMotionDirection2 = LEFT; break; 
        ...
        while(game)
        {
            ...
            while(level)
            {
                ...
                if (win)
                {
                    ...
                    for(int i=0; i<10;i++)
                    {
                        window.setTitle("----SNAKE--VS--REDCHICK----  "+(2000-i*200)+" seconde avant le début");
